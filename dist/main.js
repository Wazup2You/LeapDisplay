...
/* harmony export */   "default": () => (/* binding */ DataItem)
/* harmony export */ });
class DataItem {
    constructor(data) {
        this.data = data;
...
async function fetchApiToken() {
    await fetch(`https://dashboard.cphsense.com/api/v2/auth/new`, {
        ...
        method: 'POST',
        body: JSON.stringify({"username": "0970327@hr.nl", "password": "Luchtverfrissers"}),
    })
    .then(res => res.json())
    .then((data) => {
...
async function fetchApiData() {
    await fetch(`https://dashboard.cphsense.com/api/v2/devices/${"0123A8032A74EA24FF"}/latest`, {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
